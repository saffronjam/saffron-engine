...
const commands: CommandDef[] = [
  ...
  },
  {
    ...
    result: "SkeletonOverlayResult",
    summary: "tint a previewed rig's joint by its get-rig node index (-1 clears)",
  },
  {
    name: "set-rig-preview-options",
    params: "SetRigPreviewOptionsParams",
    result: "RigPreviewOptionsResult",
    summary: "set-rig-preview-options {floor?} — preview-scene settings (show floor)",
  },
  {
    name: "get-foot-ik",
  ...
  },
  {
    ...
    params: "GetRigParams",
    result: "RigResult",
    summary: "get-rig {asset} — a model's bone tree + clips, read from its .smodel container",
  },
  {
    name: "enter-rig-preview",
    params: "EnterRigPreviewParams",
    result: "EnterRigPreviewResult",
    summary: "enter-rig-preview {asset} — open a model's rig in an isolated preview scene",
  },
  {
    name: "exit-rig-preview",
    params: "EmptyParams",
    result: "PlayStateResult",
    summary: "exit-rig-preview — close the rig preview and restore the authored scene + camera",
  },
  {
    name: "clean-assets",
...
const commandSkips = new Map<string, string>([
  ...
  ["get-rig", "needs an imported rig — covered in make e2e"],
  ["enter-rig-preview", "needs an imported rig — covered in make e2e"],
  ["exit-rig-preview", "needs an active rig preview — covered in make e2e"],
  ["set-skeleton-highlight", "needs an active rig preview — covered in make e2e"],
  ["set-rig-preview-options", "needs an active rig preview — covered in make e2e"],
