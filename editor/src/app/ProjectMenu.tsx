...
function VsCodeIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <mask id="vscode-menu-mask" maskUnits="userSpaceOnUse" x="0" y="0" width="100" height="100">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
