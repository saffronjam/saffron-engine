...
| `asset-commands` | import-model/texture, list/rename/folder/rename-folder/move/delete/assign-asset, get-thumbnail/view-asset, save/load project | `control_commands_asset.cpp` |
