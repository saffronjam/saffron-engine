...
**Status:** IN PROGRESS (phases 01–14, 16, 17, 18 [codegen + preview render-wiring], 19-emitter-nodes + thumbnails/texture-edit; remaining: 15 hardening, 18 scene-path codegen, 20 React-Flow editor, 21 cook)
